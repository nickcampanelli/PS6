...
public class Person_Test {
	...
	public void Test() {
		...
		per3.setCity("Newark");
		per3.setFirstName("Nick");
		per3.setLastName("Campanelli");
		per3.setPostalCode(19717);
		per3.setStreet("310 Haines St");
		...
		per1.setStreet("509 Potter St");
		
		PersonDAL.updatePerson(per1);
		
		PersonDomainModel per4 = PersonDAL.getPerson(p1id);
		assertTrue(per4.getStreet().equals("509 Potter St"));
		assertTrue(per4.getCity().equals("Wilmington"));
